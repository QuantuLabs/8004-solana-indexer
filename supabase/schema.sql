...
DROP VIEW IF EXISTS agent_reputation CASCADE;
DROP FUNCTION IF EXISTS get_collection_agents CASCADE;
...
-- Get collection-scoped agent reputation summary by canonical collection id
